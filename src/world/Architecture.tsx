...
export const miniGames:MiniGame[] = [
  {id:'penalties',name:'La última',description:'Un gesto de definición. Arrastrá el remate al lugar exacto.',icon:'◎',playerOnly:true},
  ...
  {id:'keeper',name:'Lectura del remate',description:'Esperá el instante exacto para intervenir.',icon:'◇',playerOnly:true},
  {id:'duel',name:'El cruce',description:'Timing puro: entrá cuando la pelota queda expuesta.',icon:'◆',playerOnly:true},
  {id:'memory-board',name:'Código del DT',description:'La jugada aparece una vez. Reconstruí el recorrido.',icon:'▦',playerOnly:true},
  {id:'personal-run',name:'Carril fantasma',description:'El defensor perfila un lado. Rompé por el otro.',icon:'➜',playerOnly:true},
  {id:'timing-run',name:'Cambio de ritmo',description:'Una aceleración y una lectura, sin repeticiones.',icon:'⚡',playerOnly:true},
  {id:'ball-track',name:'Visión periférica',description:'Seguí la acción y reaccioná sobre el espacio real.',icon:'◉',playerOnly:true},
  ...
  {id:'through-pass',name:'Ventana',description:'Tocá directamente el hueco mientras la línea se mueve.',icon:'⇢',playerOnly:true},
